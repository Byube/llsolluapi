...
<body>
	...
	<script src="/resources/js/asrclient2.js"></script>


	<div class="wrap">
		<div class="trans_box">
			<p class="main_txt">영어</p>
			<div class="trans_txt">
				<textarea id="usa" name="usa" class="txt_is"></textarea>
			</div>
		</div>
		<div class="trans_box">
			<p class="main_txt">
				한국어 <input type="button" class="btn_transfer" id="korea"
					value="번역하기">
			</p>
			<div class="trans_txt txt_is" id="kor"></div>
		</div>
		<!-- <div class="trans_box">
			<p class="main_txt">
	...
	<a href="/llsollu"><input type="button" class="englishs"
		id="goEnglish" value="한영번역"></a>
